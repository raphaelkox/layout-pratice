...
export default function Navbar(){
    ...
    return(
        ...
        <nav className={"fixed lg:relative z-50 top-0 left-0 w-56 min-h-screen lg:min-h-full lg:flex lg:justify-self-start transform " + ( navBarState ? "translate-x-0" : "-translate-x-56") + " lg:transform-none transition bg-purple-900"}>
            NAVIGATION
        </nav>
