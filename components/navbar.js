...
export default function Navbar(){
    ...
    return(
        <>
        <div className={"lg:hiddden fixed top-0 left-0 w-full min-h-screen bg-black " + ( navBarState ? "bg-opacity-70" : "bg-opacity-0") + " transition-opacity"} onClick={() => { if(navBarState) setState(false) }}></div>
