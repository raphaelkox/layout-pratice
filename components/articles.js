export default function Articles(){
    ...
    return(
        <>
            {contentList.map(x => {
                return(
                <div className="p-1 w-full md:w-1/2 md:first:w-full h-96 bg-green-400" key={"contentSlot" + x} >
                    <div className="w-full h-full flex flex-col justify-between rounded-md bg-yellow-400" >
                        CONTENT
